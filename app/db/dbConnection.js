...
const createChatTable = () => {
  const chatListCreateQuery = `CREATE TABLE IF NOT EXISTS chatList
  (id SERIAL PRIMARY KEY, 
  userId INTEGER REFERENCES users(id) ON DELETE CASCADE,
  interlocutorId INTEGER REFERENCES users(id) ON DELETE CASCADE,
  created_on DATE NOT NULL)`;

  pool.query(chatListCreateQuery)
    .then((res) => {
      console.log(res);
      pool.end();
    })
